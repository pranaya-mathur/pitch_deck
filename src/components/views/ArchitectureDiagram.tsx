...
import { ArrowDown, Box, Server, Database, Shield, Hexagon } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-10 flex flex-col h-full">
      <header className="mb-12 border-b border-white/10 pb-8">
        ...
        <p className="text-white/50 text-lg mt-3 font-light">Sovereign-AI model-agnostic request/response runtime flow.</p>
      </header>
      ...
      <div className="flex-1 bg-white/[0.02] border border-white/10 p-12 overflow-y-auto">
        ...
        <div className="flex justify-center mb-8 mt-4">
          <div className="w-[400px] bg-white/[0.05] border border-white/30 p-5 text-center relative hover:border-[#D4AF37]/50 transition-colors">
            ...
            <p className="text-[10px] text-[#D4AF37] mt-2 font-mono uppercase tracking-widest">Zero-Trust / Protected Routes</p>
            ...
            <div className="absolute top-1/2 -right-8 lg:-right-56 transform -translate-y-1/2">
              <div className="hidden lg:flex items-center text-white/20">
                ...
                <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/30 p-4 text-center w-40">
                  ...
                  <p className="text-[9px] text-[#D4AF37]/60 mt-1 font-mono uppercase">Audit, Dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto border border-[#D4AF37]/50 bg-black/50 p-10 relative mt-4">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div className="bg-transparent border border-white/10 p-6 text-center flex flex-col items-center hover:border-white/30 transition-colors">
              ...
              <p className="text-[10px] text-white/50 mt-3 font-light leading-relaxed">Fast, deterministic PII checks, pathogen inputs.</p>
            </div>
            ...
            <div className="bg-transparent border border-white/10 p-6 text-center flex flex-col items-center hover:border-white/30 transition-colors">
              ...
              <p className="text-[10px] text-white/50 mt-3 font-light leading-relaxed">Domain specific embedding comparison, intent.</p>
            </div>
            ...
            <div className="bg-transparent border border-white/10 p-6 text-center flex flex-col items-center hover:border-white/30 transition-colors">
              ...
              <p className="text-[10px] text-white/50 mt-3 font-light leading-relaxed">LangGraph ambiguity checks, tool constraints.</p>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-white/10 flex justify-center">
            <div className="bg-white/[0.02] border border-white/20 p-5 px-8 text-center flex items-center max-w-sm">
              ...
              <div className="text-left">
                ...
                <span className="text-[9px] text-white/40 font-mono tracking-wider">Actions, Thresholds, Severity, Market Packs</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center mt-4">
          <div className="w-72 bg-transparent border border-white/20 p-5 text-center">
            ...
            <p className="text-[10px] text-white/40 mt-2 font-mono uppercase tracking-widest">OpenAI, Azure, Bedrock, Ollama</p>
          </div>
        </div>
